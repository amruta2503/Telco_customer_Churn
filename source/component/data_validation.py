...
class DataValidation:
    ...
    def outlier_detection_handle(self,data,type):
        try:
            if type == 'train':
                ...
                outlier_params_df.to_csv(self.utility_config.outlier_params_file)
                ...
                for column_name in self.outlier_params:
    ...
    def export_data_files(self,data,filename,path):
        try:
    ...
    def initiate_data_validation(self):
        ...
        test_data = self.outlier_detection_handle(train_data, type='test')

        self.export_data_files(train_data,self.utility_config.train_file_name,self.utility_config.dv_train_file_path)
        self.export_data_files(test_data, self.utility_config.test_file_name, self.utility_config.dv_test_file_path)