...
class DataTransformation:
    ...
    def initiate_data_transformation(self):
        ...
        test_data = self.feature_encoding(test_data, target='Churn',save_encoder_path=self.utility_config.dt_multi_class_encoder,type='test')
