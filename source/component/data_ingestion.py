...
import pandas as pd
from source.utility.utility import upload_artifact_to_s3
...
class DataIngestion:
    ...
    def split_data_train_test(self,data:DataFrame):
        try:
    ...
    def initiate_data_ingestion(self, key):
        try:
            ...
            if key == 'train':
                train_data, test_data = self.split_data_train_test(data)
